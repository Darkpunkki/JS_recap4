...
// 1. Find all restaurants in Helsinki
const helsinkiRestaurants = restaurants.filter(
  (restaurant) => restaurant.city === 'Helsinki'
);

console.log('helsinkiRestaurants', helsinkiRestaurants);
...
console.log('restaurants sorted by name again', newRestaurantLista);
...
restaurants.forEach((restaurant) => {
  ...
  tr.innerHTML = `<td>${restaurant.name}</td><td>${restaurant.city}</td>`;
  tableNode.appendChild(tr);
});
*/
const dialogNode = document.querySelector('dialog');

newRestaurantLista.forEach((restaurant) => {
  const tr = document.createElement('tr');
